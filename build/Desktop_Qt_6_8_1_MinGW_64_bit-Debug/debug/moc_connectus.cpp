...
namespace {
struct qt_meta_tag_ZN9connectUsE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9connectUsE = QtMocHelpers::stringData(
    "connectUs"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9connectUsE[] = {
...
Q_CONSTINIT const QMetaObject connectUs::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9connectUsE.offsetsAndSizes,
    qt_meta_data_ZN9connectUsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9connectUsE_t,
        // Q_OBJECT / Q_GADGET
...
{
    auto *_t = static_cast<connectUs *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *connectUs::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9connectUsE.stringdata0))
