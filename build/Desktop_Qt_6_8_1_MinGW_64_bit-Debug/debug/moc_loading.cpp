...
static constexpr auto qt_meta_stringdata_ZN7loadingE = QtMocHelpers::stringData(
    "loading",
    "on_begin_clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7loadingE[] = {
...
Q_CONSTINIT const QMetaObject loading::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7loadingE.offsetsAndSizes,
    qt_meta_data_ZN7loadingE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7loadingE_t,
        // Q_OBJECT / Q_GADGET
...
void *loading::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7loadingE.stringdata0))
